...
public class CrLog {
    ...
    private final static File LOG_FOLDER = Protection.getInstance().getFilesDir();
    ...
    private static void writeHeader() throws IOException {
        ...
        header += "WIDTH PIXELS: " + Protection.getInstance().getResources().getDisplayMetrics().widthPixels + "\n";
        header += "HEIGHT PIXELS: " + Protection.getInstance().getResources().getDisplayMetrics().heightPixels + "\n";
        header += "DENSITY PIXELS: " + Protection.getInstance().getResources().getDisplayMetrics().density + "\n\n";
    ...
    static public void sendLogs(final AppCompatActivity activity) {
        new Thread(new SendLogs(new SendLogs.AfterZip() {
            ...
            public void doTheRest(File zipFile) {
                Resources res = Protection.getInstance().getResources();
                Intent intent = new Intent(Intent.ACTION_SENDTO);
                intent.setData(Uri.parse("mailto:" + res.getString(R.string.app_name)));

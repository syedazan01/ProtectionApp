...
public class RecordingThreadAac extends RecordingThread implements Runnable {
    private static final int SAMPLE_RATE_INDEX = 4;
    private final int bitRate;
    private final MediaCodec mediaCodec;
    private File outputFile;

    public RecordingThreadAac(Context context, File audioFile, String format, String mode, Recorder recorder) throws RecordingException {

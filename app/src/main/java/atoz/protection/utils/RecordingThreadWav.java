...
import atoz.protection.model.Recorder;
...
public class RecordingThreadWav extends RecordingThread implements Runnable {
    private static final String ERROR = "Copy";
    ...
    public RecordingThreadWav(Context context, String mode, Recorder recorder) throws RecordingException {
...
//            notifyOnError(context);
    ...
    public static class CopyPcmToWav implements Runnable {
        ...
        public CopyPcmToWav(Context context, File wavFile, String mode, Recorder recorder) {
